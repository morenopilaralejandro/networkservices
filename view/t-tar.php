...
<html lang="es">
    <head>
        ...
        <title>Tar - Network Services</title>
    ...
    <body class="short-page">
        ...
        <section>
            ...
            <article>
                <h4>Comprimir</h4>
                <pre class="pre-no-img"><code>tar -czvf dest.tar.gz src</code></pre>
            </article>

            <article>
                <h4>Extraer</h4>
                <pre class="pre-no-img"><code>tar -xzvf src.tar.gz (dest)</code></pre>
            </article>

            <article>
                <h4>Opciones</h4>
                <ul>
                    <li>-c: crear archivo comprimido.</li>
                    <li>-x: extraer.</li>
                    <li>-z: gzip (.tar.gz).</li>
                    <li>-v: verbose.</li>
                    <li>-f: filename.</li>
