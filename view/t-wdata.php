...
<html lang="es">
    <head>
        ...
        <title>Habilitar usuario www-data - Network Services</title>
    ...
    <body class="short-page">
        ...
        <section>
            <h1>Habilitar usuario www-data</h1>

            <article>
                <h4>Paso 1: Cambiar contraseña</h4>
                <pre class="pre-no-img"><code>sudo passwd www-data</code></pre>
            </article>

            <article>
                <h4>Paso 2: Establecer /bin/bash como terminal</h4>
                <pre><code>sudo nano /etc/passwd</code></pre>
                <figure class="figure">
                    <img src="../img/screenshot/wdata1.png" class="figure-img img-fluid" alt="img">
                </figure>
            </article>
        </section>
